...
/**
 * Clase que almacena la información sobre el usario enviada en el JWT.
 * 
 * @author Juan Mariño
 *
 */
public class JwtAuthData implements UserDetails {
	...
	/**
	 * Almacena la información del cuerpo del Jwt autenticado.
	 */
	...
	/**
	 * Retorna la información del Jwt autenticado.
	 * 
	 * @return {@link Map} con la información en el cuerpo del JWT.
	 */
